...
if TYPE_CHECKING:
    from spinlock.features.sdf.config import SDFInvariantDriftConfig
...
class InvariantDriftExtractor:
    ...
    def extract(
        ...
        config: Optional['SDFInvariantDriftConfig'] = None
        ...
        Args:
            ...
            config: Optional SDFInvariantDriftConfig for feature selection
    ...
    def _compute_mass_drift(
        ...
        config: 'SDFInvariantDriftConfig'
    ) -> Dict[str, torch.Tensor]:
        """
