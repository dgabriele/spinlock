...
if TYPE_CHECKING:
    from spinlock.features.sdf.config import SDFCausalityConfig
...
class CausalityFeatureExtractor:
    ...
    def extract(
        ...
        config: Optional['SDFCausalityConfig'] = None
        ...
        Args:
            ...
            config: Optional SDFCausalityConfig for feature selection
