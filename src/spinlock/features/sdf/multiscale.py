...
if TYPE_CHECKING:
    from spinlock.features.sdf.config import SDFMultiscaleConfig
...
class MultiscaleFeatureExtractor:
    ...
    def extract(
        ...
        config: Optional['SDFMultiscaleConfig'] = None
        ...
        Args:
            ...
            config: Optional SDFMultiscaleConfig for feature selection
