...
Example:
    ...
    >>> config = SDFConfig()  # All features enabled with defaults
...
class SDFSpatialConfig(BaseModel):
    """
...
class SDFSpectralConfig(BaseModel):
    """
...
class SDFDistributionalConfig(BaseModel):
    """
...
class SDFTemporalConfig(BaseModel):
    """
...
class SDFStructuralConfig(BaseModel):
    """
...
class SDFPhysicsConfig(BaseModel):
    """
...
class SDFMorphologicalConfig(BaseModel):
    """
...
class SDFMultiscaleConfig(BaseModel):
    """
...
class SDFCrossChannelConfig(BaseModel):
    """
...
class SDFOperatorSensitivityConfig(BaseModel):
    """
...
class SDFCausalityConfig(BaseModel):
    """
...
class SDFConfig(BaseModel):
    ...
    spatial: SDFSpatialConfig = Field(default_factory=SDFSpatialConfig)
    spectral: SDFSpectralConfig = Field(default_factory=SDFSpectralConfig)
    distributional: SDFDistributionalConfig = Field(default_factory=SDFDistributionalConfig)
    temporal: SDFTemporalConfig = Field(default_factory=SDFTemporalConfig)
    structural: SDFStructuralConfig = Field(default_factory=SDFStructuralConfig)
    physics: SDFPhysicsConfig = Field(default_factory=SDFPhysicsConfig)
    morphological: SDFMorphologicalConfig = Field(default_factory=SDFMorphologicalConfig)
    multiscale: SDFMultiscaleConfig = Field(default_factory=SDFMultiscaleConfig)

    # v2.0 feature categories (new)
    operator_sensitivity: SDFOperatorSensitivityConfig = Field(default_factory=SDFOperatorSensitivityConfig)
