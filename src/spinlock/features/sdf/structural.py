...
if TYPE_CHECKING:
    from spinlock.features.sdf.config import SDFStructuralConfig
...
class StructuralFeatureExtractor:
    ...
    def extract(
        ...
        config: Optional['SDFStructuralConfig'] = None
        ...
        Args:
            ...
            config: Optional SDFStructuralConfig for feature selection
