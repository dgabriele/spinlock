...
if TYPE_CHECKING:
    from spinlock.features.sdf.config import SDFDistributionalConfig
...
class DistributionalFeatureExtractor:
    ...
    def extract(
        ...
        config: Optional['SDFDistributionalConfig'] = None
        ...
        Args:
            ...
            config: Optional SDFDistributionalConfig for feature selection
