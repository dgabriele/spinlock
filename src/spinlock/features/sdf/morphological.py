...
if TYPE_CHECKING:
    from spinlock.features.sdf.config import SDFMorphologicalConfig
...
class MorphologicalFeatureExtractor:
    ...
    def extract(
        ...
        config: Optional['SDFMorphologicalConfig'] = None
        ...
        Args:
            ...
            config: Optional SDFMorphologicalConfig for feature selection
