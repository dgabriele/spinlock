...
class ArchitectureExtractor:
    ...
    Example:
        >>> from spinlock.features.architecture import ArchitectureConfig, ArchitectureExtractor
        >>> config = ArchitectureConfig()
        >>> param_spec = {...}  # From dataset config
        >>> extractor = ArchitectureExtractor(config, param_spec)
        >>>
    ...
    def __init__(self, config: ArchitectureConfig, param_spec: Dict[str, Dict[str, Any]]):
        """
        Args:
    ...
    def _build_registry(self) -> FeatureRegistry:
        ...
        registry = FeatureRegistry(family_name="architecture")
