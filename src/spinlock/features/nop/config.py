...
class NOPArchitectureConfig(BaseModel):
...
class NOPStochasticConfig(BaseModel):
...
class NOPOperatorConfig(BaseModel):
...
class NOPEvolutionConfig(BaseModel):
...
class NOPStratificationConfig(BaseModel):
...
class NOPConfig(BaseModel):
    ...
    # Feature categories
    architecture: NOPArchitectureConfig = Field(
        default_factory=NOPArchitectureConfig,
        description="Architecture parameter features"
    )
    stochastic: NOPStochasticConfig = Field(
        default_factory=NOPStochasticConfig,
        description="Stochastic parameter features"
    )
    operator: NOPOperatorConfig = Field(
        default_factory=NOPOperatorConfig,
        description="Operator configuration features"
    )
    evolution: NOPEvolutionConfig = Field(
        default_factory=NOPEvolutionConfig,
        description="Evolution policy features"
    )
    stratification: NOPStratificationConfig = Field(
        default_factory=NOPStratificationConfig,
