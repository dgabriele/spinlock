...
if TYPE_CHECKING:
    from spinlock.features.summary.config import SummaryTemporalConfig
...
class TemporalFeatureExtractor:
    ...
    def extract(
        ...
        config: Optional['SummaryTemporalConfig'] = None
        ...
        Args:
            ...
            config: Optional SummaryTemporalConfig for feature selection
