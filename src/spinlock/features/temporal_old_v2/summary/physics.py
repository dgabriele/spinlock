...
if TYPE_CHECKING:
    from spinlock.features.summary.config import SummaryPhysicsConfig
...
class PhysicsFeatureExtractor:
    ...
    def extract(
        ...
        config: Optional['SummaryPhysicsConfig'] = None
        ...
        Args:
            ...
            config: Optional SummaryPhysicsConfig for feature selection
