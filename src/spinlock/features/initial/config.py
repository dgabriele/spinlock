...
class InitialManualConfig(BaseModel):
    """
...
class InitialCNNConfig(BaseModel):
    """
...
class InitialConfig(BaseModel):
    ...
    manual: InitialManualConfig = Field(
        default_factory=InitialManualConfig,
        description="Manual feature extraction config"
    )
    cnn: InitialCNNConfig = Field(
        default_factory=InitialCNNConfig,
    ...
    store_manual_separate: bool = Field(
        default=True,
        description="Store manual features separately in /features/initial/manual_features"
    )
    store_cnn_separate: bool = Field(
        default=True,
        description="Store CNN features separately in /features/initial/cnn_features"
    )
    store_combined: bool = Field(
        default=True,
        description="Store concatenated features in /features/initial/combined_features"
    )
