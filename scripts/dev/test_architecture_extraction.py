...
from spinlock.features.architecture.config import ArchitectureConfig
...
def test_nop_extraction():
    ...
    config = FeatureExtractionConfig(
        ...
        nop=ArchitectureConfig(
            version="1.0.0",
            architecture=ArchitectureConfig.model_fields['architecture'].default_factory(),
            stochastic=ArchitectureConfig.model_fields['stochastic'].default_factory(),
            operator=ArchitectureConfig.model_fields['operator'].default_factory(),
            evolution=ArchitectureConfig.model_fields['evolution'].default_factory(),
            stratification=ArchitectureConfig.model_fields['stratification'].default_factory(),
        )
    )
