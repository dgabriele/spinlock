...
from spinlock.encoding.encoders.temporal_cnn import TemporalCNNEncoder, ResidualBlock1D
...
class TestTDExtractor:
    ...
    def test_extractor_initialization(self):
        ...
        config = TemporalConfig()
        extractor = TemporalExtractor(config=config, device=torch.device('cpu'))
...
class TestTDCNNEncoder:
    ...
    def test_encoder_different_embedding_dims(self):
        ...
        for embedding_dim in [32, 64, 128]:
            encoder = TemporalCNNEncoder(input_dim=56, embedding_dim=embedding_dim)
...
class TestTDIntegration:
    ...
    def test_td_encoder_integration(self):
        ...
        # Encode with TD CNN
        encoder = TemporalCNNEncoder(input_dim=2, embedding_dim=64)
