...
from spinlock.v2.tokens.checkpoint import save_checkpoint, load_checkpoint, verify_pretrained_cnn
from spinlock.v2.tokens.model import JointHierarchicalVQVAE
...
def simple_config():
    ...
    from spinlock.v2.tokens.config import EncoderConfig, QuantizerConfig
